...
// gpt-5.6-sol at prices-v4 is $25/M conservative input and $90/M output.
const UNDER_CAP_USAGE = { prompt_tokens: 100, completion_tokens: 20 }; // 100·25 + 20·90 = 4,300 micros
const AT_CAP_USAGE = { prompt_tokens: 4_000_000, completion_tokens: 0 }; // 4M·25 = exactly 100,000,000 == CAP
const OVER_CAP_USAGE = { prompt_tokens: 4_000_000, completion_tokens: 1 }; // 100,000,000 + 90 = 100,000,090 > CAP
...
test('verdict: the boundary is strictly > — exactly $100 passes, over the cap breaches', () => {
  ...
  assert.equal(o?.derivedActualUsdMicros, 100_000_090);
});
