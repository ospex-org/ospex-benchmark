 ...
 *      dispatch that begins at or after that moment is refused at its own admission. This
 *      source is readable from any box that reaches the store, and it holds even when the
 *      escalation sidecar's install itself failed.
