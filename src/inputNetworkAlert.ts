...
const BRIDGE = '/home/vince/.ospex/heartbeat/ospex-mve/monitoring/enqueue_input_network.py';
...
/** Enqueue only into the existing MVE outbox. No send, restart, environment
